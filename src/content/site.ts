...
/** The trail skirts BELOW the track oval (right side). */
...
export const scenes: Scene[] = [
  ...
  },
  {
    ...
    img: "/world/slot.jpg",
    bgPos: "center 30%",
    aria: "Stylized Antelope Canyon slot with sculpted wave ledges on both walls, a light beam with drifting dust, a trickle of falling sand, a shallow reflective puddle, smooth stones, a photographer's tripod setup with an open camera bag and a laid-out print, a raven, and a walkable hiker character",
    // Round 5: the slot widened from ±336 to the shared ±600 stage (client
    // note: it read far too cramped) — floor dressing re-spread to match.
    gxClamp: 600,
    exits: { left: 0, right: 2 },
    path: SLOT_PATH,
    // Sculpted wave-ledges hug both walls (their bases blocked), the
    // photographer's setup gets a small base blocker, and everything on the
    // floor is identifiable at a glance — smooth stones, wind-rippled sand,
    // a beam-lit puddle.
    blockers: [
      { shape: "ellipse", gx: -515, gy: 32, hw: 60, hh: 5 }, // west wave-ledge
      { shape: "ellipse", gx: 520, gy: 34, hw: 60, hh: 5 }, // east wave-ledge
